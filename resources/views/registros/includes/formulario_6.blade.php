                ...
                x-data="{
                    rows: @js(
                        collect($inst?->equipos_array ?? [
                            ['label' => 'Toma de Muestra: NCh411/10.Of2005.', 'eq_val' => '', 'chk_val' => true],
                            ['label' => 'pH: (NCh2313/1.Of2021.)',             'eq_val' => '', 'chk_val' => true],
                            ['label' => 'Temperatura: (NCh2313/2.Of95.)',      'eq_val' => '', 'chk_val' => true],
                        ])->map(fn($r, $i) => [
                            'id'      => 'row_' . $i,
                            'label'   => $r['label']   ?? '',
                            'eq_val'  => $r['eq_val']  ?? '',
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div class="flex items-center gap-3 px-5 py-4 border-b border-blue-dark/8 bg-blue-dark/3">
            ...
            <div class="flex items-center gap-2">
                ...
                <h3 class="font-semibold text-blue text-sm">5. Resultados Mediciones In Situ</h3>
            </div>
        </div>
            ...
            x-data="{
                ...
                rows: @js(
                    !empty($inst?->mediciones_detalle['rows'])
                        ...
                        : [
                            ['id'=>'row_0', 'item'=>'RIL', 'values'=>['fecha'=>'','hora'=>'','ph'=>'','temp'=>'']],
                            ['id'=>'row_1', 'item'=>'SST',    'values'=>['fecha'=>'','hora'=>'','ph'=>'','temp'=>'']],
                        ]
                ),
