            ...
            <table class="w-full text-sm min-w-[600px]">
                <thead>
                    <tr class="bg-gray-50 rounded-xl">
                        ...
                        <th class="text-left px-4 py-2.5 text-xs font-semibold text-gray-500 rounded-r-xl">Cloro Libre (mg/l)</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                        @foreach([
                        ...
                        <tr class="hover:bg-gray-50/50">
                            ...
                            @foreach([
                                ...
                                ['type'=>'number', 'name'=>'r_cl_'.$row['suffix'], 'val'=>$row['cl_val'], 'step'=>'0.01'],
                            ] as $cell)
                                <td class="px-4 py-3">
