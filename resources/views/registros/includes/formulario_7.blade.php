...
@php
    ...
    $logDefaults = ['Vehículo propio', 'Arriendo Camioneta', 'Pasajes Aéreo', 'Hotel / Cabañas', 'Alimentación'];
    $matColA = [
        'Cajas Plásticas',
        'Amarras eléctricas',
        'Bidones',
        ...
        'Rodamina',
        'Formalina',
        'Tablas para apoyos documentos',
        'Libretas impermeables de Terreno',
        'Plumones',
        'Lápices Pasta, Grafitos y Gomas',
        'Hielo o Ice Pack',
        'Coolers',
        'Envases de Muestreo',
        'Huincha de Medir',
        'Cuadricula - Intermareal',
        'Guantes Quirúrgicos',
        'Mascarillas',
        'Guantes de seguridad',
        'Botella Niskin Horizontal',
        'Botella Van Dorn Vertical',
    ];
    $matColB = [
        'Corer Sampler de PVC',
        'Dragas Van Veen',
        'GPS Garmin Etrex 20',
        'Disco Secchi',
        'Mallas Fito-Zoo',
        'Malla Sar-Ber para Rio Fito-Zoo',
        'Malla para Captura de Peces',
        'Grameras para pesar peces',
        'Ictiometros',
        'Chequeo Cables de Equipos',
        ...
        'Botas de Agua c/s Punta de fierro',
        'Trajes de Agua (Verdes) con botas',
    ...
    $equipDefaults = [
        ...
        'Notebook o Tablet',
        'Cámaras de Captura Nocturnas para Fauna',
        'Cámaras Fotográficas',
        'Otro',
    ];

    /* mapas para edición */
    $docMap = collect($inst->documentacion ?? [])
        ->keyBy('item')
        ->toArray();
    $logMap = collect($inst->logistica ?? [])
        ->keyBy('item')
        ->toArray();
    $matMap = collect($inst->materiales ?? [])
        ->keyBy('item')
        ->toArray();
    $equipMap = collect($inst->equipos_chequeo ?? [])
        ->keyBy('equipo')
        ->toArray();
@endphp
...
<form method="POST" id="Formulario"
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div class="p-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4">
            ...
            <div class="lg:col-span-6 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">Título
                    del Informe</label>
                <div
                    class="flex items-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-focus-within:border-orange group-focus-within:bg-white group-focus-within:shadow-[0_0_0_3px_rgba(255,140,66,0.15)] hover:border-blue-light/60">
            ...
            <div class="lg:col-span-3 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">Código
                    Informe</label>
                <div
                    class="flex items-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-focus-within:border-orange group-focus-within:bg-white group-focus-within:shadow-[0_0_0_3px_rgba(255,140,66,0.15)] hover:border-blue-light/60">
            ...
            <div class="lg:col-span-3 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">Fecha
                    Emisión</label>
                <div
                    class="flex items-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-focus-within:border-orange group-focus-within:bg-white group-focus-within:shadow-[0_0_0_3px_rgba(255,140,66,0.15)] hover:border-blue-light/60">
            ...
            <div class="lg:col-span-4 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">Cliente
                    / Razón Social</label>
                <div
                    class="flex items-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-focus-within:border-orange group-focus-within:bg-white group-focus-within:shadow-[0_0_0_3px_rgba(255,140,66,0.15)] hover:border-blue-light/60">
            ...
            <div class="lg:col-span-3 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">RUT
                    Empresa</label>
                <div
                    class="flex items-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-focus-within:border-orange group-focus-within:bg-white group-focus-within:shadow-[0_0_0_3px_rgba(255,140,66,0.15)] hover:border-blue-light/60">
            ...
            <div class="lg:col-span-5 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">Nombre
            ...
            <div class="lg:col-span-4 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">RUN
                    Representante Legal</label>
                <div
                    class="flex items-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-focus-within:border-orange group-focus-within:bg-white group-focus-within:shadow-[0_0_0_3px_rgba(255,140,66,0.15)] hover:border-blue-light/60">
                    <input type="text" name="representante_run"
                        value="{{ old('representante_run', $reg->representante_run ?? '') }}" placeholder="12.345.678-9"
                        class="w-full bg-transparent border-none px-3 py-2 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-0">
                </div>
            </div>
            ...
            <div class="lg:col-span-4 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">Región</label>
                <div
                    class="flex items-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-focus-within:border-orange group-focus-within:bg-white group-focus-within:shadow-[0_0_0_3px_rgba(255,140,66,0.15)] hover:border-blue-light/60">
                    <input type="text" name="region" value="{{ old('region', $reg->region ?? '') }}"
            ...
            <div class="lg:col-span-4 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">Comuna
                    / Ciudad</label>
                <div
                    class="flex items-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-focus-within:border-orange group-focus-within:bg-white group-focus-within:shadow-[0_0_0_3px_rgba(255,140,66,0.15)] hover:border-blue-light/60">
                    <input type="text" name="comuna" value="{{ old('comuna', $reg->comuna ?? '') }}"
            ...
            <div class="lg:col-span-8 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">Dirección
                    Cliente</label>
                <div
                    class="flex items-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-focus-within:border-orange group-focus-within:bg-white group-focus-within:shadow-[0_0_0_3px_rgba(255,140,66,0.15)] hover:border-blue-light/60">
            ...
            <div class="lg:col-span-4 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">N°
                    RCA</label>
                <div
                    class="flex items-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-focus-within:border-orange group-focus-within:bg-white group-focus-within:shadow-[0_0_0_3px_rgba(255,140,66,0.15)] hover:border-blue-light/60">
                    <input type="text" name="n_rca" value="{{ old('n_rca', $reg->n_rca ?? '') }}"
            ...
            <div class="lg:col-span-4">
                ...
                <div class="flex items-center gap-2">
                    <div
                        class="flex-1 flex items-center rounded-xl border border-gray-200 bg-gray-50 hover:border-blue-light/60 transition-all duration-200 overflow-hidden">
                        <label
                            class="flex-shrink-0 px-3 py-2 text-xs text-gray-500 bg-gray-100 border-r border-gray-200 cursor-pointer hover:bg-gray-200 transition-colors">
                            Seleccionar
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div class="p-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4">
            ...
            <div class="lg:col-span-8 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">Proyecto</label>
                <div
                    class="flex items-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-focus-within:border-orange group-focus-within:bg-white group-focus-within:shadow-[0_0_0_3px_rgba(255,140,66,0.15)] hover:border-blue-light/60">
            ...
            <div class="lg:col-span-4 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">Participantes</label>
                <div
                    class="flex items-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-focus-within:border-orange group-focus-within:bg-white group-focus-within:shadow-[0_0_0_3px_rgba(255,140,66,0.15)] hover:border-blue-light/60">
            ...
            <div class="lg:col-span-4 group">
                <label
                    class="block text-xs font-medium text-gray-500 mb-1.5 transition-colors group-focus-within:text-orange">Responsable
                    Verificación</label>
                <div
                    class="flex items-center rounded-xl border border-gray-200 bg-gray-50 transition-all duration-200 group-focus-within:border-orange group-focus-within:bg-white group-focus-within:shadow-[0_0_0_3px_rgba(255,140,66,0.15)] hover:border-blue-light/60">
                ...
                <div class="flex items-center gap-2">
                    <div
                        ...
                        <label
                            class="flex-shrink-0 px-3 py-2 text-xs text-gray-500 bg-gray-100 border-r border-gray-200 cursor-pointer hover:bg-gray-200 transition-colors">
                            Seleccionar
                            <input type="file" name="firma_responsable_verificacion" accept="image/*"
                                class="hidden"
                ...
                <div class="flex items-center gap-2">
                    <div
                        ...
                        <label
                            class="flex-shrink-0 px-3 py-2 text-xs text-gray-500 bg-gray-100 border-r border-gray-200 cursor-pointer hover:bg-gray-200 transition-colors">
                            Seleccionar
                            <input type="file" name="firma_responsable_aprobacion" accept="image/*"
                                class="hidden"
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div class="p-5">
            <p class="text-xs text-gray-400 mb-3 flex items-center gap-1.5">
                ...
                Marque cada ítem una vez que haya verificado que está disponible y en buenas condiciones para esta
                campaña.
            </p>
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-200">
                            ...
                            <th class="text-center px-4 py-2.5 text-xs font-semibold text-gray-500 w-24">Verificado
                            </th>
                            <th class="text-left px-4 py-2.5 text-xs font-semibold text-gray-500 w-1/3">Observaciones
                            </th>
                        </tr>
                    </thead>
                        ...
                        @foreach ($docDefaults as $idx => $itemName)
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                <td class="px-4 py-2.5 text-sm text-gray-700">
                                    <input type="hidden" name="documentacion[{{ $idx }}][item]"
                                        value="{{ $itemName }}">
                                    {{ $itemName }}
                                </td>
                                <td class="px-4 py-2.5 text-center">
                                    <input type="checkbox" name="documentacion[{{ $idx }}][verificado]"
                                        value="1" {{ !empty($saved['verificado']) ? 'checked' : '' }}
                                        class="w-4 h-4 rounded border-gray-300 text-orange focus:ring-orange cursor-pointer">
                                </td>
                                <td class="px-4 py-2.5">
                                    <div
                                        class="flex items-center rounded-lg border border-gray-200 bg-gray-50 transition-all duration-150 focus-within:border-orange focus-within:bg-white focus-within:shadow-[0_0_0_2px_rgba(255,140,66,0.15)]">
                                        <input type="text"
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @foreach ($logDefaults as $idx => $itemName)
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                <td class="px-4 py-2.5 text-sm text-gray-700">
                                    <input type="hidden" name="logistica[{{ $idx }}][item]"
                                        value="{{ $itemName }}">
                                    {{ $itemName }}
                                </td>
                                <td class="px-4 py-2.5 text-center">
                                    <input type="checkbox" name="logistica[{{ $idx }}][verificado]"
                                        value="1" {{ !empty($saved['verificado']) ? 'checked' : '' }}
                                        class="w-4 h-4 rounded border-gray-300 text-orange focus:ring-orange cursor-pointer">
                                </td>
                                <td class="px-4 py-2.5">
                                    <div
                                        class="flex items-center rounded-lg border border-gray-200 bg-gray-50 transition-all duration-150 focus-within:border-orange focus-within:bg-white focus-within:shadow-[0_0_0_2px_rgba(255,140,66,0.15)]">
                                        <input type="text" name="logistica[{{ $idx }}][observaciones]"
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="bg-gray-50 border-b border-gray-200">
                                ...
                                <th class="text-center px-3 py-2.5 text-xs font-semibold text-gray-500 w-16">Inicio
                                </th>
                                <th class="text-center px-3 py-2.5 text-xs font-semibold text-gray-500 w-16">Término
                                </th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-100">
                            @foreach ($matColA as $idx => $itemName)
                                ...
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    <td class="px-4 py-2 text-xs text-gray-700">
                                        <input type="hidden" name="materiales[{{ $idx }}][item]"
                                            value="{{ $itemName }}">
                                        {{ $itemName }}
                                    </td>
                                    <td class="px-3 py-2 text-center">
                                        <input type="checkbox" name="materiales[{{ $idx }}][inicio]"
                                            value="1" {{ !empty($saved['inicio']) ? 'checked' : '' }}
                                            class="w-4 h-4 rounded border-gray-300 text-orange focus:ring-orange cursor-pointer">
                                    </td>
                                    <td class="px-3 py-2 text-center">
                                        <input type="checkbox" name="materiales[{{ $idx }}][termino]"
                                            value="1" {{ !empty($saved['termino']) ? 'checked' : '' }}
                                            class="w-4 h-4 rounded border-gray-300 text-orange focus:ring-orange cursor-pointer">
                                    </td>
                                </tr>
                            @endforeach
        ...
        <div class="p-5">
            <div class="overflow-hidden rounded-xl border border-gray-200">
                <div x-data="{
                    ...
                    selectedValues: @js(
    collect($equipDefaults ?? [])
        ->mapWithKeys(function ($equipName, $idx) use ($equipMap) {
        ...
        ->toArray(),
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="bg-gray-50 border-b border-gray-200">
                                <th class="text-left px-4 py-2.5 text-xs font-semibold text-gray-500 w-1/4">Equipo</th>
                                <th class="text-left px-4 py-2.5 text-xs font-semibold text-gray-500">Modelo</th>
                                <th class="text-left px-4 py-2.5 text-xs font-semibold text-gray-500">N° Serie</th>
                                <th class="text-center px-3 py-2.5 text-xs font-semibold text-gray-500 w-16">Inicio
                                </th>
                                <th class="text-center px-3 py-2.5 text-xs font-semibold text-gray-500 w-16">Término
                                </th>
                            ...
                            @foreach ($equipDefaults as $idx => $equipName)
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-4 py-2.5 text-xs font-medium text-gray-700">
                                        <input type="hidden" name="equipos_chequeo[{{ $idx }}][equipo]"
                                            value="{{ $equipName }}">
                                        {{ $equipName }}
                                    </td>

                                    {{-- Modelo — dropdown searchable con descripción --}}
                                    <td class="px-4 py-2">
                                        <div x-data="{
                                            open: false,
                                            search: '',
                                            ...
                                            open_dd() {
                                                ...
                                                this.$nextTick(() => this.$refs.modeloSearch?.focus());
                                            },
                                            close() {
                                                this.open = false;
                                                if (this._sh) {
                                                    window.removeEventListener('scroll', this._sh, true);
                                                    this._sh = null;
                                                }
                                            },
                                            ...
                                            <input type="hidden"
                                                :name="`equipos_chequeo[{{ $idx }}][modelo]`"
                                                x-model="selectedValues[{{ $idx }}].modelo">
                                            ...
                                            <button type="button" x-ref="modeloTrigger" @click="toggle()"
                                                ...
                                                :class="selectedValues[{{ $idx }}].modelo ? 'text-gray-800' :
                                                    'text-gray-400'">
                                                <span class="truncate"
                                                    x-text="selectedValues[{{ $idx }}].modelo
                                                    ? (modelosData.find(m => m.nombre === selectedValues[{{ $idx }}].modelo)?.descripcion
                                                        ? selectedValues[{{ $idx }}].modelo + ' — ' + modelosData.find(m => m.nombre === selectedValues[{{ $idx }}].modelo).descripcion
                                                        : selectedValues[{{ $idx }}].modelo)
                                                    : '— Modelo —'">
                                                </span>
                                                <svg class="w-3 h-3 text-gray-400 flex-shrink-0 ml-1 transition-transform duration-150"
                                                ...
                                                <div x-show="open" :style="dropdownStyle"
                                                    ...
                                                    <div class="rounded-lg border border-gray-200 bg-white shadow-lg">
                                                        <div class="p-1.5 border-b border-gray-100">
                                                            <div
                                                                class="flex items-center gap-1.5 rounded-md border border-gray-200 bg-gray-50 px-2 py-1 focus-within:border-orange focus-within:bg-white">
                                                                <svg class="w-3 h-3 text-gray-400 shrink-0"
                                                                ...
                                                                <button x-show="search" @click.stop="search = ''"
                                                                    type="button"
                                                        ...
                                                        <ul class="max-h-48 overflow-y-auto py-1">
                                                            <li @click.stop="select('')"
                                                                ...
                                                                :class="selectedValues[{{ $idx }}]
                                                                    .modelo === '' &&
                                                                    'bg-orange/5 font-medium text-orange'">
                                                                — Ninguno —
                                                            </li>
                                                            <template x-for="modelo in filtered"
                                                                :key="modelo.nombre">
                                                                <li @click.stop="select(modelo.nombre)"
                                                                    class="px-3 py-2 cursor-pointer hover:bg-orange/10 transition-colors"
                                                                    :class="selectedValues[{{ $idx }}].modelo ===
                                                                        modelo.nombre && 'bg-orange/10'">
                                                                    <p class="text-xs font-semibold"
                                                                        :class="selectedValues[{{ $idx }}].modelo ===
                                                                            modelo.nombre ? 'text-orange' :
                                                                            'text-blue-dark'"
                                                                        x-text="modelo.nombre"></p>
                                                                    <p x-show="modelo.descripcion"
                                                                        class="text-[10px] text-gray-400 mt-0.5 truncate"
                                                                        x-text="modelo.descripcion"></p>
                                                                </li>
                                                            </template>
                                                            <li x-show="filtered.length === 0"
                                                                class="px-3 py-2 text-xs text-gray-400 text-center">Sin
                                                                resultados</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                    ...
                                    {{-- N° Serie — dropdown searchable con descripción + modelos --}}
                                    <td class="px-4 py-2">
                                        <div x-data="{
                                            open: false,
                                            search: '',
                                            ...
                                            open_dd() {
                                                ...
                                                this._sh = () => { if (this.open) this.calcPos(); };
                                                window.addEventListener('scroll', this._sh, true);
                                                this.$nextTick(() => this.$refs.serieSearch?.focus());
                                            },
                                            close() {
                                                this.open = false;
                                                if (this._sh) {
                                            ...
                                            <input type="hidden"
                                                :name="`equipos_chequeo[{{ $idx }}][n_serie]`"
                                                x-model="selectedValues[{{ $idx }}].n_serie">

                                            <button type="button" x-ref="serieTrigger" @click="toggle()"
                                                class="w-full flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 px-2.5 py-1.5 text-xs transition-all duration-150 focus:border-orange focus:bg-white focus:outline-none"
                                                :class="selectedValues[{{ $idx }}].n_serie ? 'text-gray-800' :
                                                    'text-gray-400'">
                                                <span class="truncate"
                                                    x-text="selectedValues[{{ $idx }}].n_serie
                                                    ? (equiposData.find(e => e.codigo === selectedValues[{{ $idx }}].n_serie)?.descripcion
                                                        ? selectedValues[{{ $idx }}].n_serie + ' — ' + equiposData.find(e => e.codigo === selectedValues[{{ $idx }}].n_serie).descripcion
                                                        : selectedValues[{{ $idx }}].n_serie)
                                                    : '— N° Serie —'">
                                                </span>
                                                <svg class="w-3 h-3 text-gray-400 flex-shrink-0 ml-1 transition-transform duration-150"
                                                    :class="open && 'rotate-180'" fill="none" viewBox="0 0 24 24"
                                                ...
                                                <div x-show="open" :style="dropdownStyle"
                                                    ...
                                                    <div class="rounded-lg border border-gray-200 bg-white shadow-lg">
                                                        ...
                                                        <ul class="max-h-48 overflow-y-auto py-1">
                                                            ...
                                                            <template x-for="equipo in filtered"
                                                                :key="equipo.codigo">
                                                                <li @click.stop="select(equipo.codigo)"
                                                                    class="px-3 py-2 cursor-pointer hover:bg-orange/10 transition-colors"
                                                                    :class="selectedValues[{{ $idx }}].n_serie ===
                                                                        equipo.codigo && 'bg-orange/10'">
                                                                    <p class="text-xs font-semibold"
                                                                        :class="selectedValues[{{ $idx }}].n_serie ===
                                                                            equipo.codigo ? 'text-orange' :
                                                                            'text-blue-dark'"
                                                                        x-text="equipo.codigo"></p>
                                                                    <p x-show="equipo.descripcion"
                                                                        class="text-[10px] text-gray-400 mt-0.5 truncate"
                                                                        x-text="equipo.descripcion"></p>
                                                                    <div x-show="equipo.modelos && equipo.modelos.length"
                                                                        class="flex flex-wrap gap-1 mt-1">
                                                                        <template x-for="mod in equipo.modelos"
                                                                            :key="mod">
                                                                            <span
                                                                                class="inline-flex items-center px-1.5 py-0.5 rounded bg-blue/10 text-blue text-[9px] font-medium"
                                                                                x-text="mod"></span>
                                                                        </template>
                                                                    </div>
                                                                </li>
                                    ...
                                    <td class="px-3 py-2.5 text-center">
                                        <input type="hidden" :name="`equipos_chequeo[{{ $idx }}][inicio]`"
                                            value="0">
                                        <input type="checkbox" x-model="selectedValues[{{ $idx }}].inicio"
                                            :name="`equipos_chequeo[{{ $idx }}][inicio]`" value="1"
                                            class="w-4 h-4 rounded border-gray-300 text-orange focus:ring-orange cursor-pointer">
                                    </td>

                                    {{-- Término --}}
                                    <td class="px-3 py-2.5 text-center">
                                        <input type="hidden" :name="`equipos_chequeo[{{ $idx }}][termino]`"
                                            value="0">
                                        <input type="checkbox" x-model="selectedValues[{{ $idx }}].termino"
                                            :name="`equipos_chequeo[{{ $idx }}][termino]`" value="1"
                                            class="w-4 h-4 rounded border-gray-300 text-orange focus:ring-orange cursor-pointer">
                                    </td>
